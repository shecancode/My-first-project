...
//   for(var i = 0; i < theGame.player1.playerHand; i++){
    
//  } 

//  for(var i = 0; i < theGame.player2.playerHand; i++){
...
//   for(var i = 0; i < theGame.player1.playerHand.length; i++){
  
//   }
//   for(var x = 0; x < theGame.player2.playerHand.lnegth; i++){

//   }

//   });
// rearrnge the DOM here
//
//
//
//
...
// $(".start").click(function(){
//   theGame.player1.playerHand(theGame.cardsArray)
//   var html = '';
//   theGame.cardsArray.forEach(function (pic, index) {
//     html += '<div class= "card" id="card_' + pic.name + '">';
//     html += '    name="'       + pic.img +  '">';
//     html += '</div>';
//     html += '<div class="front" ';
//     html += 'style="background: url(image/' + pic.img + ') no-repeat">';
//     html += '</div>';
//   });
  ...
  // function makeCard( image, name, description, attackPoints) {
  //   var card = $(".card1").clone();
    
  //   card.removeClass("template");
    
  //   card.find("img").html(theGame.player1.playerHand);
  //   card.find("name").html("&"+name+";");
    
  //   // if( suit === "image" || suit === "diams" ) {
  //   //   card.addClass("red");
  //   // }
